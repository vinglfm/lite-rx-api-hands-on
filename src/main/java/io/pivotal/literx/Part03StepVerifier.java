...
//========================================================================================
    ...
    void expectFooBarComplete(Flux<String> flux) {
        StepVerifier.create(flux).expectNext("foo", "bar");
    }
...
//========================================================================================
    ...
    void expectSkylerJesseComplete(Flux<User> flux) {
        StepVerifier.create(flux).expectNextMatches(user -> "swhite".equals(user.getUsername())).expectNextMatches(user -> "jpinkman".equals(user.getUsername()));
    }
...
//========================================================================================
    ...
    void expect10Elements(Flux<Long> flux) {
        StepVerifier.create(flux, 10).expectComplete();
    }
